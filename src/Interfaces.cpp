...
void Interfaces::create()
{
	try
	{
        ...
        if(!GD::defaultPhysicalInterface) GD::defaultPhysicalInterface = std::make_shared<IEnOceanInterface>(std::make_shared<BaseLib::Systems::PhysicalInterfaceSettings>());
	}
